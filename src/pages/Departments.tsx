...
const Departments = () => {
  ...
  const examPhases = [
    { id: "Mid-Semester", name: "Mid-Semester", description: "Focused study materials covering first half", icon: "📚" },
    { id: "End-Semester", name: "End-Semester", description: "Comprehensive materials for full syllabus", icon: "🎯" },
  ];
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="text-center">
                    <div className="font-bold text-lg text-primary">{dept.stats.decks}</div>
                    <div className="text-sm text-muted-foreground">Decks</div>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-lg text-secondary">{dept.stats.students}</div>
                ...
                {/* Subjects */}
                <div className="mb-4">
                  <h4 className="font-medium text-sm uppercase text-muted-foreground mb-2">Subjects</h4>
                ...
                {activeDept === dept.id && activeYear && !activePhase && (
                  <div className="grid gap-4">
                    ...
                    <Button variant="outline" onClick={() => { setActiveYear(null); setFlippedIndex(null); }}>
                      ← Back to Years
                    </Button>
                  </div>
                )}
                ...
                {activeDept === dept.id && activeYear && activePhase && (
                  <div>
                        ...
                        filteredCards.map((card, i) => (
                          <div key={card.id} className="flex flex-col items-center">
                            <div className="card-perspective w-full h-40">
                              <div className={`card-3d ${flippedIndex === i ? "is-flipped" : ""}`}>
                                {/* Front */}
                    ...
                    <Button variant="outline" className="mt-4" onClick={() => { setActivePhase(null); setFlippedIndex(null); }}>
